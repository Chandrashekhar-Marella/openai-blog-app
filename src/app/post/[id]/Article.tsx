        ...
        <article className="text-wh-500 leading-8">
            ...
            { isEditable && (
                <div className="border-2 rounded-md bg-wh-50 p-3 mb-3">
                    ...
                    <p className="text-sm text-wh-500"><span className="font-bold">Note:&nbsp;</span>For the purpose of evaluating the AI feature, the generation of sample content had been limited to two-line blog posts.</p>
